...
def nitsche_rigid_surface(
    ...
    mesh coming into contact with a rigid surface (meshed) with constant
    normal n_2.
    ...
    form_compiler_options
        ...
        opdirichlet_value_rigidtions. Takes priority over all other
        parameter values, except for `scalar_type` which is determined
        by DOLFINX.
    jit_options
