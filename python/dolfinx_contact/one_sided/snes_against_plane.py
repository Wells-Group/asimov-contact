...
def snes_solver(mesh: dmesh.Mesh, mesh_data: Tuple[dmesh.MeshTags, int, int],
                ...
                quadrature_degree: int = 5, form_compiler_parameters: Dict = {},
                jit_parameters: Dict = {}, petsc_options: Dict = {}, snes_options: Dict = {}) -> _fem.Function:
    """
    ...
    problem = NonlinearPDE_SNESProblem(F, u, bc, jit_parameters=jit_parameters,
