...
def snes_solver(
    ...
    """Solving contact problem against a rigid plane with gap -g from y=0
    using PETSc SNES solver.
    ...
    snes_options
        Parameters to pass to the snes solver, see the
        `SNES-documentation
    ...
    problem = NonlinearPDE_SNESProblem(
        F, u, bc, jit_options=jit_options, form_compiler_options=form_compiler_options
    )
