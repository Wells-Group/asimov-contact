...
def nitsche_rigid_surface_custom(mesh: _mesh.Mesh, mesh_data: Tuple[_cpp.mesh.MeshTags_int32, int, int, int, int],
    ...
    # Create RHS kernels
    F_custom = _fem.form(F, jit_options=jit_options, form_compiler_params=form_compiler_params)
    ...
    J_custom = _fem.form(J, jit_options=jit_options, form_compiler_params=form_compiler_params)
