...
if __name__ == "__main__":
    ...
    u1 = nitsche_rigid_surface(mesh=mesh, mesh_data=mesh_data, physical_parameters=physical_parameters,
                               ...
                               nitsche_bc=nitsche_bc, quadrature_degree=3, petsc_options=petsc_options, newton_options=newton_options)

    with XDMFFile(mesh.comm, f"results/u_rigid.xdmf", "w") as xdmf:
