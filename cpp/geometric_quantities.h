...
///
/// Computes the outward unit normal fora a point x located on the
/// surface of the physical cell. Each point x has a corresponding facet
...
/// transform n_phys = J^{-T} n_ref / ||J^{-T} n_ref||. See: DOI:
/// 10.1137/08073901X
///
