...
int main(int argc, char* argv[])
{
  ...
  spdlog::set_pattern(fmt);
  {
    ...
    //     mu->interpolate(
    //         [mu_val](auto x) -> std::pair<std::vector<T>,
    //         std::vector<std::size_t>>
    //         {
    //           std::vector<T> _f;
    //           for (std::size_t p = 0; p < x.extent(1); ++p)
    ...
    //     f->interpolate(
    //         [bs](auto x) -> std::pair<std::vector<T>,
    //         std::vector<std::size_t>>
    //         {
    ...
    //     std::vector<std::shared_ptr<dolfinx::mesh::MeshTags<std::int32_t>>>
    //     markers
    //         =
    //         {std::make_shared<dolfinx::mesh::MeshTags<std::int32_t>>(facet1)};
    //     std::vector<std::array<int, 2>> pairs = {{0, 1}, {1, 0}};
    //     auto meshties
    //         = dolfinx_contact::MeshTie(markers, contact_markers, pairs, mesh,
    //         5);

    //     meshties.generate_kernel_data(dolfinx_contact::Problem::Elasticity,
    //     V,
    //                                   {{"mu", mu}, {"lambda", lmbda}}, E *
    //                                   gamma, theta);
    ...
    //     dolfinx::la::Vector<T>
    //     b(F->function_spaces()[0]->dofmap()->index_map,
    ...
    //         dolfinx::la::petsc::Matrix::set_fn(A.mat(), INSERT_VALUES), *V,
    //         {bc});
    ...
    //     dolfinx::la::petsc::options::set("ksp_norm_type",
    //     "unpreconditioned"); dolfinx::la::petsc::options::set("ksp_monitor");
    ...
    //     _b(dolfinx::la::petsc::create_vector_wrap(b),
    //                                   false);
