...
///
/// @param[in] type The kernel type (`Rhs`, `Jac`, `TrescaRhs`, `TrescaJac`,
/// CoulombRhs, CoulombJac). for the right hand side vector/jacobian for
/// frictionless contact or tresca friction
...
/// @note The scalar valued coefficients `mu`,`lmbda`, the friciont coefficient
/// `s`, and `h` are expected to be DG-0 functions, with a single value per
/// facet.
