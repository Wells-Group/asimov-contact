...
using mdspan2_t = stdex::mdspan<double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>>;
using cmdspan2_t = stdex::mdspan<const double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>>;
using mdspan3_t = stdex::mdspan<double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 3>>;
using cmdspan3_t = stdex::mdspan<const double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 3>>;
using mdspan4_t = stdex::mdspan<double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 4>>;
using cmdspan4_t = stdex::mdspan<const double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 4>>;
using s_cmdspan2_t
    = stdex::mdspan<const double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 2>,
                    stdex::layout_stride>;
using s_cmdspan3_t
    = stdex::mdspan<const double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 3>,
                    stdex::layout_stride>;
using s_cmdspan4_t
    = stdex::mdspan<const double, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 4>,
                    stdex::layout_stride>;
